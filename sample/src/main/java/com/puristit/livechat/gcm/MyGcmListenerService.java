...
import com.puristit.livechat.activities.ChatActivity;
...
public class MyGcmListenerService extends GcmListenerService {
    ...
    private void sendNotification(String message) {
        Intent intent;
        try {
            String chatUrl = MyUtils.getSharedPrefString(this, "ChatUrl", "");

            JSONObject jsonObject = new JSONObject(message);
            String room = jsonObject.optJSONObject("data").optString("pcs_room");
            String notiMsg = jsonObject.optJSONObject("data").optString("alert");
